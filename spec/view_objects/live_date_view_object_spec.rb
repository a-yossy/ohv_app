...
RSpec.describe LiveDateViewObject, type: :model do
  describe 'live_dates' do
    ...
    it { is_expected.to eq [["all_live", -Float::INFINITY..Float::INFINITY], ["2021-02", Date.new(2021,2,1).in_time_zone.all_month], ["2021-01", Date.new(2021,1,1).in_time_zone.all_month]].to_set }
  end
end
